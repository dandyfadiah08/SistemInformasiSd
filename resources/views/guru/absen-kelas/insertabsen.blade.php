    ...
    <div class="col-md-6">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Absensi Pembelajaran</h3>
              </div>
              <div class="card-body">
                <!-- Date -->
                <!-- /.form group -->
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" id="exampleInputEmail1" placeholder="JUDUL PEMBELAJARAN">
                  </div>
                  <!-- /.input group -->
                </div>
                <div class="form-group">
                ...
                <div class="col-md6">
                    ...
                    <option value="1">B Indonesia</option>
                    </select>
                </div>
                  </div>
                  <!-- /.input group -->
                ...
                <!-- Date and time range -->
                <div class="form-group">
                  <label class="mt-2">Date and time range:</label>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <button type="button" class="btn btn-default float-right" >
                      <i class="far fa-calendar-alt"></i> Simpan Absen
                    </button>
                  </div>
                </div>
                <!-- /.form group -->
                ...
                <div class="card-footer">
                    waktu pelaksanaan sampai waktu akhir di gunakan untuk siswa absensi sebelum waktu Habis
                </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
