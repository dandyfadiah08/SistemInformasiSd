...
<div class="modal fade" id="modal-default2">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form role="form" action="{{ route('tambah.absen')}}" method="POST" enctype="multipart/form-data">
                  @csrf
            ...
            <div class="row">
              ...
              <label class="mt-2">Jam Absensi</label>

              <div class="input-group">
              <div class="input-group-prepend">
              <span class="input-group-text"><i class="far fa-clock"></i></span>
              </div>
              <input type="date" name="waktuabsen" class="form-control float-right" id="reservationtime">
              </div>
                </div>
                <!-- /.form-group -->
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <h4 class="modal-title">Keterangan Tidak Hadir</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form role="form" action="{{ route('tambah.keteranganabsen')}}" method="POST" enctype="multipart/form-data">
                  @csrf
            <div class="modal-body">
            ...
            <div class="col-md-6">
              <div class="form-group">
                  <label>WAKTU</label>
                  <input type="date"  name="waktu" class="form-control" placeholder="Enter ...">
                </div>
                <!-- /.form-group -->
              ...
              <div class="form-group">
                  ...
                  <select class="form-control" name="keterangan"  data-placeholder="Select a State" style="width: 100%;">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item has-treeview">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="{{ route('absenguru') }}" class="nav-link active">
              <i class="nav-icon fas fa-table"></i>
              <p>
            ...
            <ol class="breadcrumb float-sm-right">
              ...
              <div class="input-group-prepend">
                    ...
                    <div class="dropdown-menu">
                      <a class="dropdown-item"  data-toggle="modal" data-target="#modal-default2">Masuk</a>
                      <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal-default">Tidak Masuk</a>
                  </div>
              </div>
            </ol>
          </div>
