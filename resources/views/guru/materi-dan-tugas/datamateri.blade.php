        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Materi dan Tugas Siswa</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form role="form" action="{{ route('tambah.materi.tugas')}}" method="POST" enctype="multipart/form-data">
                  @csrf
                ...
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" name="keterangan_mapel" class="form-control" placeholder="Isi Judul Pembelajaran">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                      <select class="form-control" name="mapel_id"  data-placeholder="Select a State" style="width: 100%;">
                      @foreach($mapel as $item)
                              <option value="{{ $item->id}}">{{ $item->jenis_kelas}} - {{$item->mata_pelajaran}}</option>
                      @endforeach        
                      </select>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-md-6">
                        <label >Waktu mulai absen Siswa</label>
                        <input type="date" name="waktu_mulai_absen_siswa" class="form-control">
                      </div>
                      <div class="col-md-6 floay-right">
                        <label >Waktu akhir absen Siswa</label>
                        <input type="date" name="waktu_akhir_absen_siswa" class="form-control">
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input accept="image/*" name="gambar_materi"  class="custom-file-input" type="file" id="gambar_materi">
                        <label class="custom-file-label" for="gambar_materi">Choose file</label>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input name="video_materi" accept="video/*" type="file" class="custom-file-input" id="video_materi">
                        <label class="custom-file-label" for="video_materi">Choose file</label>
                      </div>
                    </div>
                  </div>
                      <label>
                      ...
                      <textarea name="keterangan_materi" id="" cols="30" rows="5" class="form-control" placeholder="Kolom Keterangan Materi"></textarea>
                    </div>
                    <!-- /.post -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input name="gambar_tugas" accept="image/*" type="file" class="custom-file-input" id="exampleInputFile">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input name="video_tugas" accept="video/*" type="file" class="custom-file-input" id="video_tugas">
                        <label class="custom-file-label" for="video_tugas">Choose file</label>
                      </div>
                    </div>
                  </div>
                      <label>
                      ...
                      <textarea name="keterangan_tugas" id="" cols="30" rows="5" class="form-control" placeholder="Kolom Keterangan Tugas"></textarea>
                    </div>
                    <!-- /.post -->
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item has-treeview">
            <a href="{{ route('IndexGuru') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview ">
              <li class="nav-item">
                <a href="{{ route('materi.tugas') }}" class="nav-link active">
              ...
              <li class="nav-item">
                <a href="{{ route('pas.siswa') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>PAS</p>
                </a>
              </li>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        @if(Session::has('success'))
          ...
          <div class="col-sm-6">
          <H3>Data Materi dan Tugas Siswa</H3> 
         </div>
          <div class="float-sm-right">
          <a href="#"><button type="button" data-toggle="modal" data-target="#modal-lg" class="btn btn-block btn-primary">Tambah Materi</button></a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body"> 
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th colspans="2">Status</th>
                  </thead>
                  <tbody>
                  @foreach($mapeldantugas as $mp)
                  
                    <tr>
                      <td>{{$mp->keterangan_mapel}}</td>
                      <td>{{$mp->waktu_mulai_absen_siswa}}</td>
                      <td>
                      <div class="btn-group btn-group-sm">
                        <a href="#" class="btn btn-info"><i class="fas fa-edit"></i></a>
                        <a href="#" class="btn btn-success"><i class="fas fa-child"></i></a>
                        <a href="{{ URL::to('delete/mapeltugas/'.$mp->id)}}" onclick="return confirm('APAKAH Mata Pelajaran INI AKAN DIHAPUS?')" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </div>
                      </td>
                    </tr>
                    @endforeach
