        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Soal Pas Siswa</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form role="form" action="{{ route('tambah.pas.siswa')}}" method="POST" enctype="multipart/form-data">
                  @csrf
                ...
                <div class="tab-content">
                  ...
                  <div class="form-group">
                    ...
                    <div class="post">
                      <!-- /.user-block -->
                      <div class="form-group">
                    <label >Upload Documen pas</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input  name="soal_pas"  class="custom-file-input" type="file" id="gambar_materi">
        ...
        <li class="nav-item has-treeview">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview ">
              ...
              <li class="nav-item">
                <a href="{{ route('pas.siswa') }}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>PAS</p>
                </a>
              </li>
