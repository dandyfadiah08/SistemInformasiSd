        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Soal Uts Siswa</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form role="form" action="{{ route('tambah.uts.siswa')}}" method="POST" enctype="multipart/form-data">
                  @csrf
                ...
                <div class="tab-content">
                  ...
                  <div class="form-group">
                    ...
                    <div class="post">
                      <!-- /.user-block -->
                      <div class="form-group">
                    <label >Upload Documen uts</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input  name="soal_uts"  class="custom-file-input" type="file" id="gambar_materi">
                      ...
                      <textarea name="keterangan_tambahan" id="" cols="30" rows="5" class="form-control" placeholder="Kolom Keterangan Materi"></textarea>
                    </div>
                    <!-- /.post -->
        ...
        <li class="nav-item has-treeview">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview ">
              ...
              <li class="nav-item">
                <a href="{{ route('uts.siswa') }}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>UTS</p>
                </a>
              </li>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        @if(Session::has('success'))
          ...
          <div class="col-sm-6">
          <H3>Data Soal Uts Siswa</H3> 
         </div>
          <div class="float-sm-right">
          <a href="#"><button type="button" data-toggle="modal" data-target="#modal-lg" class="btn btn-block btn-primary">Upload Soal</button></a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
