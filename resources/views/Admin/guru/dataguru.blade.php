        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <div>
              <a href="{{ route('create.guru') }}"><button type="button" class="btn btn-block btn-primary">TAMBAH GURU</button></a>
              </div>
            </ol>
          </div>
        </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $g->jenis_ptk }}</td>
                      <td>
                          <a class="btn btn-block bg-gradient-info" href="{{ URL::to('show/detail/guru/'.$g->NUPTK) }}">Show</a>
                          <hr>
                          <a class="btn btn-block bg-gradient-warning" href="{{ URL::to('edit/guru/'.$g->NUPTK)}}">Edit</a>
                          <hr>
                          <a class="btn btn-block bg-gradient-danger" href="{{ URL::to('delete/guru/'.$g->NUPTK)}}" onclick="return confirm('APAKAH Data Guru {{$g->nama_guru}} INI AKAN DIHAPUS?')">Hapus</a>
                      </td>
                    </tr>
                     @endforeach
