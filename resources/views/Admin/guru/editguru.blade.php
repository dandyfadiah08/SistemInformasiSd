        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form role="form" action="{{ url('update/guru/'.$guru->NUPTK)}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label>NUPTK</label>
                        <input type="number" readonly name="NUPTK" class="form-control" value="{{$guru->NUPTK}}">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <!-- text input -->
                      <div class="form-group">
                        ...
                        <input type="text" name="nama_guru" class="form-control" placeholder="Enter ..." value="{{$guru->nama_guru}}">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="ttl" class="form-control"  value="{{$guru->ttl}}">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6">
                      ...
                      <label>TOTAL JJM</label>
                        <input type="number" name="total_JJM" class="form-control"  value="{{$guru->total_JJM}}">
                    </div>
                  </div>
                 </div>   
