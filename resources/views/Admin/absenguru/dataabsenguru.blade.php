...
<head>
  ...
  <title>Admin | Data Record Absen Guru</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>DATA SISWA SD NEGERI 02 CILILIN</h1>
          </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Record Absen Guru</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @foreach($guru as $g)
                    <tr>
                      ...
                      <td>{{$g->nama_guru}}</td>
                      <td>
                      <a class="btn btn-block bg-gradient-warning" href="{{ URL::to('record-absen-guru/'.$g->NUPTK)}}">Show Record</a>
                          <hr>
                      </td>
                    </tr>
                  @endforeach
