        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form action="{{ url('update/pelajaran/'.$pelajaran->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                            <label class="label">NAMA Mata Pelajaran</label>
                            <input class="input--style-4 col-2" type="text" name="mata_pelajaran" value="{{ $pelajaran->mata_pelajaran}}">
                            <br><br>
