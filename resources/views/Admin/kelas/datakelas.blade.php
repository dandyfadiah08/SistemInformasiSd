      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item has-treeview menu-open">
            <a href="{{ route('kelas') }}" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 >IDENTIFIKASI KELAS SD 02 CILILIN</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <div>
              <a href="{{ route('create.kelas')}}"><button type="button" class="btn btn-block btn-primary">TAMBAH KELAS</button></a>
              </div>
            </ol>
          </div>
        </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data-Data Kelas yang Tersedia</h3>
